    ...
    <div style="max-width: 700px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 2rem;">
            ...
            <h1 style="font-size: 1.875rem; font-weight: 700; margin-bottom: 0.5rem; letter-spacing: -0.025em;">
                <i class="bi bi-plus-circle" style="margin-right: 0.5rem; color: hsl(var(--primary));"></i>
                Create New Note
            </h1>
            <p class="text-muted text-sm" style="margin: 0;">Your note will be encrypted end-to-end</p>
        </div>
            ...
            <div class="card-body-minimal">
                ...
                <form id="create-form">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="input-minimal" id="title" placeholder="Enter note title" required autofocus>
                    </div>
                    ...
                    <div class="flex gap-2" style="margin-top: 1.5rem;">
                        ...
                        <button type="submit" class="btn-minimal btn-primary-minimal" id="submit-btn" style="flex: 1;">
                            ...
                            <span id="btn-text">Save Note</span>
                        </button>
                    </div>
                </form>
            </div>
...
document.getElementById('create-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        showAlert('✗ Failed to create note: ' + error.message, 'danger');
